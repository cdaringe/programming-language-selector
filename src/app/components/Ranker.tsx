...
import { LangMetaByLang, LangRatingByDomain, PLSelectParams } from "../model";

import rawData from "../../../scripts/data.json";
import rawDomainData from "../../../scripts/datadomain.json";
